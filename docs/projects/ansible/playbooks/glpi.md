...
- **ITSM/GLPI/Plugin/FormCreator/Delete/Form_Answer** Delete the specified form answer from the GLPI Plugin formcreator.

- **ITSM/GLPI/Plugin/FormCreator/to_JSON_Object** Fetch a Form Creator Plugin formcreator.
